...
import 'package:souapp/views/airbub_screen.dart';

import '../utils/appcolors_theme.dart';

class VacationResourcesScreen extends StatelessWidget {
  VacationResourcesScreen({Key? key}) : super(key: key);
  final List<String> entries = <String>
  ['assets/images/Mask grop (2).png',
    'assets/images/Mask group (3).png',
   'assets/images/Mask group (4).png',
    'assets/images/Mask group (5).png',];
  final List<String> data = <String>['AirBnB', 'Emirates Trips', 'Hotels.ng',"Hotels.ng"];
