...
import 'package:souapp/views/availableresources_screen.dart';
import 'package:souapp/views/savingonboard_screen.dart';

import '../utils/app_button.dart';
import '../utils/appcolors_theme.dart';
import '../utils/appstrings.dart';

class TopUpChallengeScreen extends StatelessWidget {
  const TopUpChallengeScreen({Key? key}) : super(key: key);
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: Text('This amount may be added to your cycle every save date',
                          maxLines: 2,
                        ...
                        Row(
                          children: [
                            ...
                            Image.asset('assets/images/savedate.png'),
                          ],
                        ),
